...
if __name__ == "__main__":
    municipio = "Barcelona"
    municipio, temperatura, velocidad_viento, cielos, cod = openweathermap(municipio)
    
    if cod == 200:
        patata = openai(municipio, temperatura, velocidad_viento, cielos)
        print(patata)